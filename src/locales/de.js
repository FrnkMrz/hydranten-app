export default {
    ...
    confirm: {
        ...
        water_source_main: "Leitungsnetz (main)",
        water_source_groundwater: "Grundwasser (groundwater)",
        water_source_pond: "Teich (pond)",
        water_source_lake: "See (lake)",
        water_source_river: "Fluss (river)",
        water_source_reservoir: "Speicher/Becken (reservoir)",
        save_btn: "Speichern",
