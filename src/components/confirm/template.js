    ...
    <div class="h-full w-full bg-slate-900 text-white flex flex-col animate-fade-in pb-safe">
      ...
      <div class="relative w-full h-[25vh] bg-gray-800 shrink-0">
        ...
        <div class="absolute bottom-4 left-4 z-50">
                       <button id="map-expand-btn" class="bg-black/40 backdrop-blur-md p-3 rounded-full text-white hover:bg-black/60 transition shadow-lg border border-white/10" aria-label="${t('confirm.position_adjustable')}">
