  ...
  return `
    <div class="h-full w-full bg-slate-900 text-white flex flex-col animate-fade-in pb-safe">
      ...
      <div class="relative w-full h-[25vh] bg-gray-800 shrink-0">
        ...
        <div class="absolute left-4 z-50" style="top: calc(1.5rem + env(safe-area-inset-top, 20px));">
        ...
        <!-- Accuracy Pill & Retry -->
        <div class="absolute right-4 z-50 flex flex-col items-end gap-2" style="top: calc(1.5rem + env(safe-area-inset-top, 20px));">
